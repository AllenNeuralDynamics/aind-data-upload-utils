...
from aind_data_upload_utils.delete_folders_job import (
    DeleteFoldersJob,
    JobSettings,
)
...
class TestJobSettings(unittest.TestCase):
    ...
    def test_class_constructor(self):
        ...
        job_settings = JobSettings(directories=[SMART_SPIM_DIR, EPHYS_DIR])
    ...
    def test_regex_pattern(self):
        ...
        job_settings = JobSettings(directories=[SMART_SPIM_DIR])
...
class TestDeleteStagingFolderJob(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        job_settings = JobSettings(
            directories=[SMART_SPIM_DIR, EPHYS_DIR], num_of_dir_levels=1
        )
    ...
    @patch(
        "aind_data_upload_utils.delete_folders_job."
        "DeleteFoldersJob._remove_directory"
    )
    @patch("logging.debug")
    def test_run_job(
        self,
